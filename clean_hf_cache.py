...
for repo in list(hf_cache_info.repos):
	if repo.repo_id in ('tloen/alpaca-lora-7b', 'decapoda-research/llama-7b-hf', 'samwit/alpaca13B-lora', 'decapoda-research/llama-13b-hf', 'chavinlo/alpaca-native', 'beomi/KoAlpaca-13B-LoRA', 'beomi/KoAlpaca-Polyglot'):
